            ...
            <div className="map-content">
                <div className="sidebar">
                    <div className="summary-section">
                        ...
                        {isSummaryExpanded && (
                            <div className="summary-content" style={{ maxHeight: '300px', overflowY: 'auto' }}>
                ...
                <div className="map-wrapper" style={{ position: 'relative' }}>
                    <div className="legend-overlay glass-panel p-3" style={{ position: 'absolute', bottom: '20px', right: '20px', zIndex: 1000, backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
                        <h4 className="h6 fw-bold mb-2">Map Legend</h4>
                        <ul className="list-unstyled mb-0 small">
                            <li className="d-flex align-items-center mb-1"><span className="d-inline-block rounded-circle me-2" style={{ width: 12, height: 12, backgroundColor: '#ef4444' }}></span> High Severity</li>
                            <li className="d-flex align-items-center mb-1"><span className="d-inline-block rounded-circle me-2" style={{ width: 12, height: 12, backgroundColor: '#f97316' }}></span> Medium Severity</li>
                            <li className="d-flex align-items-center mb-1"><span className="d-inline-block rounded-circle me-2" style={{ width: 12, height: 12, backgroundColor: '#22c55e' }}></span> Low Severity</li>
                            <li className="d-flex align-items-center"><span className="d-inline-block rounded-circle me-2" style={{ width: 12, height: 12, backgroundColor: '#3b82f6' }}></span> Your Location</li>
                        </ul>
                    </div>
                    <MapContainer
