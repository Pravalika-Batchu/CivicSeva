...
from .models import Issue, IssueComment, DepartmentNotification, Department, SolveRequest, StatusLog
...
class IssueSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'category', 'severity', 'status', 'citizen', 'citizen_username',
            'assigned_user', 'assigned_to_username', 'department', 'department_name',
            ...
            'user_vote', 'resolved_by_citizen', 'resolved_by_officer', 'resolver_info',
            'status_logs'
        ]
    ...
    def get_resolver_info(self, obj):
        if obj.resolved_by:
            role_display = "Citizen" if obj.resolved_by.role == "CITIZEN" else "Officer"
            return {
    ...
    def get_volunteer_deadline(self, obj):
        ...
        if obj.severity == "High":
            ...
            return obj.created_at + timedelta(hours=12)
        else: # Low
